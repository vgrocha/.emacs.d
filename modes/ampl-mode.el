...
(defun ampl-mode ()
  ...
  (defun ampl-insert-comment ()
    ...
    (let ((point-a (point))
	  ...
	  point-b point-c)
      (insert-string ampl-user-comment)
      (setq point-b (point))
